...
int main(int argc, char *argv[]) {
    ...
    for (size_t i = 0; i < N; i++){
        ...
        if(Ty[i]!=-1 && Ty[i]==i+Np+1){
            ...
            switch(Np){
                case 1:
                    mpo_gen.AddTerm( g, {bupcF, x, bupa }, op_sites);
            ...
            switch(Np){
                case 1:
                    mpo_gen.AddTerm( g, {bupcF, bupa,  x}, op_sites, inst_ops, inst_ops_idxs_set);
                ...
                case 4:{
                    ...
                    mpo_gen.AddTerm(g, {bupcF,bupa,x,sqrt(13)*m+sqrt(15)*n,n,n},op_sites, inst_ops, inst_ops_idxs_set);

                    mpo_gen.AddTerm(g, {bupcF,bupa,a,adag,sqrt(2)*m+sqrt(6)*n,m},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(g, {bupcF,bupa,adag,a,sqrt(2)*m+sqrt(6)*n,m},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(g, {bupcF,bupa,a,adag,sqrt(10)*m+sqrt(14)*n,n},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(g, {bupcF,bupa,adag,a,sqrt(10)*m+sqrt(14)*n,n},op_sites, inst_ops, inst_ops_idxs_set);

                    mpo_gen.AddTerm(g,{bupcF,bupa,a,a,adag,sqrt(4)*P0+sqrt(12)*P1},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(g,{bupcF,bupa,adag,adag,a,sqrt(4)*P0+sqrt(12)*P1},op_sites, inst_ops, inst_ops_idxs_set);
                    ...
                    mpo_gen.AddTerm(g, {bdnc,Fbdna,x,sqrt(13)*m+sqrt(15)*n,n,n},op_sites, inst_ops, inst_ops_idxs_set);

                    mpo_gen.AddTerm(g, {bdnc,Fbdna,a,adag,sqrt(2)*m+sqrt(6)*n,m},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(g, {bdnc,Fbdna,adag,a,sqrt(2)*m+sqrt(6)*n,m},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(g, {bdnc,Fbdna,a,adag,sqrt(10)*m+sqrt(14)*n,n},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(g, {bdnc,Fbdna,adag,a,sqrt(10)*m+sqrt(14)*n,n},op_sites, inst_ops, inst_ops_idxs_set);

                    mpo_gen.AddTerm(g,{bdnc,Fbdna,a,a,adag,sqrt(4)*P0+sqrt(12)*P1},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(g,{bdnc,Fbdna,adag,adag,a,sqrt(4)*P0+sqrt(12)*P1},op_sites, inst_ops, inst_ops_idxs_set);
                    ...
                    mpo_gen.AddTerm(-g, {bupaF,bupc,x,sqrt(9)*m+sqrt(11)*n,m,n},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g, {bupaF,bupc,x,sqrt(13)*m+sqrt(15)*n,n,n},op_sites, inst_ops, inst_ops_idxs_set);

                    mpo_gen.AddTerm(-g, {bupaF,bupc,a,adag,sqrt(2)*m+sqrt(6)*n,m},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g, {bupaF,bupc,adag,a,sqrt(2)*m+sqrt(6)*n,m},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g, {bupaF,bupc,a,adag,sqrt(10)*m+sqrt(14)*n,n},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g, {bupaF,bupc,adag,a,sqrt(10)*m+sqrt(14)*n,n},op_sites, inst_ops, inst_ops_idxs_set);

                    mpo_gen.AddTerm(-g,{bupaF,bupc,a,a,adag,sqrt(4)*P0+sqrt(12)*P1},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g,{bupaF,bupc,adag,adag,a,sqrt(4)*P0+sqrt(12)*P1},op_sites, inst_ops, inst_ops_idxs_set);
                    ...
                    mpo_gen.AddTerm(-g, {bdna,Fbdnc,x,sqrt(9)*m+sqrt(11)*n,m,n},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g, {bdna,Fbdnc,x,sqrt(13)*m+sqrt(15)*n,n,n},op_sites, inst_ops, inst_ops_idxs_set);

                    mpo_gen.AddTerm(-g, {bdna,Fbdnc,a,adag,sqrt(2)*m+sqrt(6)*n,m},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g, {bdna,Fbdnc,adag,a,sqrt(2)*m+sqrt(6)*n,m},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g, {bdna,Fbdnc,a,adag,sqrt(10)*m+sqrt(14)*n,n},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g, {bdna,Fbdnc,adag,a,sqrt(10)*m+sqrt(14)*n,n},op_sites, inst_ops, inst_ops_idxs_set);

                    mpo_gen.AddTerm(-g,{bdna,Fbdnc,a,a,adag,sqrt(4)*P0+sqrt(12)*P1},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g,{bdna,Fbdnc,adag,adag,a,sqrt(4)*P0+sqrt(12)*P1},op_sites, inst_ops, inst_ops_idxs_set);
        ...
        if(Tx[i]!=-1){
            int residue=i%((2*Np+1)*Ly );
            int y = residue/(Np+1);
            int x_coor = i/((2*Np+1)*Ly );
            int phonon1 = x_coor*((2*Np+1)*Ly )+ Ly*(Np+1) + Np*y;
            vector<size_t> op_sites(Np+2);
            op_sites[0] = i; op_sites.back() = Tx[i];
            for(size_t j = 0 ; j<Np; j++){
            ...
            switch(Np){
                case 1:
                    mpo_gen.AddTerm( g, {bupcF, x, bupa },op_sites, inst_ops, inst_ops_idxs_set);
                ...
                case 4:{
                    ...
                    mpo_gen.AddTerm(g, {bupcF,x,sqrt(13)*m+sqrt(15)*n,n,n,bupa},op_sites, inst_ops, inst_ops_idxs_set);

                    mpo_gen.AddTerm(g, {bupcF,a,adag,sqrt(2)*m+sqrt(6)*n,m,bupa},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(g, {bupcF,adag,a,sqrt(2)*m+sqrt(6)*n,m,bupa},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(g, {bupcF,a,adag,sqrt(10)*m+sqrt(14)*n,n,bupa},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(g, {bupcF,adag,a,sqrt(10)*m+sqrt(14)*n,n,bupa},op_sites, inst_ops, inst_ops_idxs_set);

                    mpo_gen.AddTerm(g,{bupcF,a,a,adag,sqrt(4)*P0+sqrt(12)*P1,bupa},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(g,{bupcF,adag,adag,a,sqrt(4)*P0+sqrt(12)*P1,bupa},op_sites, inst_ops, inst_ops_idxs_set);
                    ...
                    mpo_gen.AddTerm(g, {bdnc,x,sqrt(13)*m+sqrt(15)*n,n,n,Fbdna},op_sites, inst_ops, inst_ops_idxs_set);

                    mpo_gen.AddTerm(g, {bdnc,a,adag,sqrt(2)*m+sqrt(6)*n,m,Fbdna},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(g, {bdnc,adag,a,sqrt(2)*m+sqrt(6)*n,m,Fbdna},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(g, {bdnc,a,adag,sqrt(10)*m+sqrt(14)*n,n,Fbdna},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(g, {bdnc,adag,a,sqrt(10)*m+sqrt(14)*n,n,Fbdna},op_sites, inst_ops, inst_ops_idxs_set);

                    mpo_gen.AddTerm(g,{bdnc,a,a,adag,sqrt(4)*P0+sqrt(12)*P1,Fbdna},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(g,{bdnc,adag,adag,a,sqrt(4)*P0+sqrt(12)*P1,Fbdna},op_sites, inst_ops, inst_ops_idxs_set);
                    ...
                    mpo_gen.AddTerm(-g, {bupaF,x,sqrt(9)*m+sqrt(11)*n,m,n,bupc},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g, {bupaF,x,sqrt(13)*m+sqrt(15)*n,n,n,bupc},op_sites, inst_ops, inst_ops_idxs_set);

                    mpo_gen.AddTerm(-g, {bupaF,a,adag,sqrt(2)*m+sqrt(6)*n,m,bupc},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g, {bupaF,adag,a,sqrt(2)*m+sqrt(6)*n,m,bupc},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g, {bupaF,a,adag,sqrt(10)*m+sqrt(14)*n,n,bupc},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g, {bupaF,adag,a,sqrt(10)*m+sqrt(14)*n,n,bupc},op_sites, inst_ops, inst_ops_idxs_set);

                    mpo_gen.AddTerm(-g,{bupaF,a,a,adag,sqrt(4)*P0+sqrt(12)*P1,bupc},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g,{bupaF,adag,adag,a,sqrt(4)*P0+sqrt(12)*P1,bupc},op_sites, inst_ops, inst_ops_idxs_set);
                    ...
                    mpo_gen.AddTerm(-g, {bdna,x,sqrt(9)*m+sqrt(11)*n,m,n,Fbdnc},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g, {bdna,x,sqrt(13)*m+sqrt(15)*n,n,n,Fbdnc},op_sites, inst_ops, inst_ops_idxs_set);

                    mpo_gen.AddTerm(-g, {bdna,a,adag,sqrt(2)*m+sqrt(6)*n,m,Fbdnc},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g, {bdna,adag,a,sqrt(2)*m+sqrt(6)*n,m,Fbdnc},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g, {bdna,a,adag,sqrt(10)*m+sqrt(14)*n,n,Fbdnc},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g, {bdna,adag,a,sqrt(10)*m+sqrt(14)*n,n,Fbdnc},op_sites, inst_ops, inst_ops_idxs_set);

                    mpo_gen.AddTerm(-g,{bdna,a,a,adag,sqrt(4)*P0+sqrt(12)*P1,Fbdnc},op_sites, inst_ops, inst_ops_idxs_set);
                    mpo_gen.AddTerm(-g,{bdna,adag,adag,a,sqrt(4)*P0+sqrt(12)*P1,Fbdnc},op_sites, inst_ops, inst_ops_idxs_set);
                ...
                default:
                    cout<<"Do not support for Np>4" <<endl;
                    exit(0);
            }
        }
    }
    ...
    int ChargePeriod=8;
    if(Perturbation){
        for(long i=0;i<ElectronSite.size();i++) {
            int x = i/ Ly;
    ...
    auto e0 = gqmps2::SingleSiteFiniteVMPS(mps, mpo, sweep_params);
