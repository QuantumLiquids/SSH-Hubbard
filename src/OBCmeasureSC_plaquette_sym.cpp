/*
    OBCmeasureSC_plaquette_sym.cpp
...
int main(int argc, char *argv[]) {
  ...
  vector<vector<size_t>> justify_symmetry_fourpoint_sitessetF; // Phi_yx, Phi_yy', Phi_yy''
...
//  }
  ...
  cout << "measured yx, yy', yy'' four point function.<====" <<endl;
