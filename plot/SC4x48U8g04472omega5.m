...
Dset=[10000,12000,14000];%bond dimension set
...
%fit_x=[1/10,1/12,1/14];%1/D
fit_x=[1.15e-6,9.74e-07,8.89e-07];%Site278
for i=1:numel(distance)
    p = fit(fit_x(1:3)',scsyy(1:3,i),'poly1');
    scsyy_ex(i)=p.p2;
end
...
l=legend(h,'$D=10000$', '$12000$','$14000$');
