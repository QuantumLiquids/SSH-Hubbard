...
ReducedChargeCorrelation_ex_mean= mean(reshape(ReducedChargeCorrelation_ex,4,[]),1);
loglog(unique(distance), abs(ReducedChargeCorrelation_ex_mean),'o');hold on;
...
T=text(6,4.5e-3,['$K_{c}=',num2str(-p.p1, 3),'$']);
set(T,'Interpreter','latex');set(T,'Fontsize',24);
...
figure_name_eps = 'ChargeCorrelationo1over12.eps';
