...
Dset=[12000,14000,16000];%bond dimension set
...
%fit_x=[1/12,1/14];%1/D
fit_x=1e7*[2.13e-06,1.78e-06, 1.63e-06];%Site  669
...
T=text(3,5.0e-4,['$K_{sc}=',num2str(-p.p1),'$']);
set(T,'Interpreter','latex');set(T,'Fontsize',24);



l=legend(h,'$D=12000$', '$14000$','$16000$');
