...
Dset=[8000,9000,10000,12000, 13000, 14000,16000];%bond dimension set

trunc_err=1e7*[3.47e-6,3.12e-6,2.88e-6,2.47e-06, 2.32e-06,   2.20e-06,1.98e-6];
D=Dset(1);
...
fit_x = trunc_err;
for i=1:numel(distance)
    p = fit(fit_x(5:end)',ChargeDensity(5:end,i),'poly1');
