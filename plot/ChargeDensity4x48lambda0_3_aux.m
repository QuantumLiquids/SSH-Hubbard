...
Dset=[8000,10000,12000,14000,16000, 18000];
...
for i=13
    p = fit(fit_x(1:end)',ChargeDensity(1:end,i),'poly2');
    ChargeDensity_ex(i)=p.p3;
    
    p = fit(fit_x',ChargeDensity(:,i),'poly2');
    ChargeDensity(i)=p.p3;
    plot( [0.0, fit_x], [ChargeDensity_ex(i), ChargeDensity(:,i)'], 'o');hold on;
