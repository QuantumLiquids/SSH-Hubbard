...
D = 8000;
FileNamePostfix=['OXssh',num2str(Ly),'x',num2str(Lx),'U',num2str(U),'g',num2str(g),'omega',num2str(omega),'Np',num2str(Np),'hole',num2str(Numhole),'D',num2str(D),'.json'];
% FileNamePostfix=['.json'];
ChargeDensityData = jsondecode(fileread(['../data/nf',FileNamePostfix]));
ChargeDensityData = ChargeDensityData(end-end/20:end,:);
